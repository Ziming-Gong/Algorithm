 ...
 * 游游需要购买的可乐数量是 m，其中手头拥有的 10,50,100 面额硬币的枚数分别是 OA.MaxNumDinstinctNum.a,b,c，可乐的价格是x(x是10的倍数)。
 * 如果游游优先使用大面额购买且钱是够的情况下,请计算出需要投入硬币次数？ 输入描述 依次输入， 需要可乐的数量为 m 10元的张数为 OA.MaxNumDinstinctNum.a 50元的张数为 b
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testTime; i++) {
            ...
            if (ans1 != ans2) {
                ...
                System.out.println("int OA.MaxNumDinstinctNum.a = " + a + ";");
